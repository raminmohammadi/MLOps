gcloud beta compute instance-templates create #template-name \
--project=cloud-compute-labs \
--machine-type=e2-micro \
--network-interface=network-tier=PREMIUM,stack-type=IPV4_ONLY,subnet=#vpc-subnet-name \
--instance-template-region=#region-name\
--metadata=startup-script=\#\!/bin/bash$'\n'$'\n'\#\ Navigate\ to\ the\ project\ directory$'\n'cd\ home/MLOps/Labs/GCP_Labs/Compute_Engine_Labs/Lab2$'\n'$'\n'\#\ Activate\ the\ virtual\ environment$'\n'.\ env/bin/activate$'\n'$'\n'\#\ Start\ the\ FastAPI\ service$'\n'nohup\ python3\ imdb_sentiment_analysis_service.py\ \& \
